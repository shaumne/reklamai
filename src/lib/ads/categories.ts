...
export type AdCategory = {
  ...
  camera: string;
  musicStyle: string;
  voiceoverTemplate: { tr: string; en: string; ja: string };
...
export const AD_CATEGORIES: AdCategory[] = [
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "{product}。輝きは、あなたのために。{campaign} 今すぐチェック。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "スタイルを語れ。{product}で、毎瞬がランウェイに。{campaign}",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "素肌の輝きを引き出そう。{product}。{campaign}",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "その力を、手に。{product}。{campaign} 新時代のテクノロジー。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "おうちを、くつろぎの場所へ。{product}。{campaign}",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "五感を満たす美味しさ。{product}。{campaign} 今すぐ注文を。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "一皿ごとに、物語を。{product}。{campaign} 席をご用意しました。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "新しい自分に、出会おう。{product}。{campaign} 今すぐ予約を。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "限界を超えろ。{product}。{campaign} 今日から始めよう。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "あなたの健康を、確かな手で。{product}。{campaign}",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "理想の暮らしが、ここから始まる。{product}。{campaign}",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "道は、あなたのもの。{product}。{campaign} 試乗してみませんか。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "毎日を、もっと簡単に。{product}。{campaign} 今すぐダウンロード。",
    },
    directorNotes:
  ...
  },
  {
    ...
    voiceoverTemplate: {
      ...
      ja: "忘れられない夜へ。{product}。{campaign} チケットはお早めに。",
    },
    directorNotes:
